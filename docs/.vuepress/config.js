    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          {
            text: "前端功能",
            items: [{ text: "富文本编辑器", link: "/front/editor/" }],
          },
          {
            text: "服务端功能",
            items: [
            ...
            items: [
              {
                ...
                link: "/server/spring-boot-starter/",
              },
              {
                text: "spring-boot-starter-security",
                link: "/server/spring-boot-starter-security/",
              },
              {
                text: "spring-boot-starter-data-jpa",
                link: "/server/spring-boot-starter-data-jpa/overview.md",
              },
              {
                text: "spring-boot-starter-data-elasticsearch",
                link: "/server/spring-boot-starter-data-elasticsearch/",
              },
              {
                text: "spring-boot-starter-amqp",
                link: "/server/spring-boot-starter-amqp/",
              },
              {
                text: "spring-boot-starter-aop",
                link: "/server/spring-boot-starter-aop/",
              },
              {
                text: "spring-boot-starter-logging",
                link: "/server/spring-boot-starter-logging/",
              },
              {
                text: "spring-boot-starter-test",
                link: "/server/spring-boot-starter-test/",
              },
            ],
          },
        ],
      ...
      "/server/spring-boot-starter-data-jpa/": [
        {
          title: "开发规范",
          collapsable: true,
          children: ["/server/spring-boot-starter-data-jpa/overview.md"],
        },
      ],
    },
  },
